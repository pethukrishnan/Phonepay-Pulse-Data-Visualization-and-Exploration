...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\kpaps\OneDrive\Desktop\phone\pe-logo-animation.gif"),width= 600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\kpaps\OneDrive\Desktop\phone\Phonepay _logo.jpg"),width=600)
